-- 🔧 แก้ไข sleep_log table แบบทีละขั้นตอน (แก้ไข Type Casting Error)
...
-- =====================================================
-- STEP 2: ตรวจสอบข้อมูลเดิมก่อนแก้ไข
-- =====================================================
...
SELECT 
  ...
  COUNT(CASE WHEN bedtime IS NOT NULL THEN 1 END) as bedtime_count,
  COUNT(CASE WHEN wake_time IS NOT NULL THEN 1 END) as wake_time_count
...
-- =====================================================
-- STEP 3: แก้ไข sleep_quality column
-- =====================================================
...
-- =====================================================
-- STEP 4: แก้ไข bedtime และ wake_time columns
-- =====================================================
...
-- =====================================================
-- STEP 6: อัปเดตข้อมูลเดิม (แก้ไข Type Casting Error)
-- =====================================================

-- อัปเดตข้อมูลเดิมให้ตรงกับ schema ใหม่
-- ใช้ explicit type casting เพื่อหลีกเลี่ยง error
...
-- =====================================================
-- STEP 8: สร้าง trigger สำหรับอัปเดต updated_at อัตโนมัติ
-- =====================================================
...
-- =====================================================
-- STEP 11: ตรวจสอบ schema หลังแก้ไข
-- =====================================================
