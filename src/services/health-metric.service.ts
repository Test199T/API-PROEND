...
export class HealthMetricService {
  ...
  async updateHealthMetric(id: string, userId: number, updateData: any) {
    return await this.supabaseService.updateHealthMetric(id, userId, updateData);
  }
  ...
  async getMetricsByType(userId: string, metricType: string, query?: any) {
    return await this.supabaseService.getMetricsByType(userId, metricType, query);
  }
  ...
  async getHealthMetricsSummary(userId: string, startDate: string, endDate: string) {
    return await this.supabaseService.getHealthMetricsSummary(userId, startDate, endDate);
  }
  ...
  async exportHealthMetrics(userId: string, format: string = 'json', query?: any) {
    return await this.supabaseService.exportHealthMetrics(userId, format, query);
  }
}
