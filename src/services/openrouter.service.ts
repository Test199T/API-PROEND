...
- รวมข้อมูล: แคลอรี่, โปรตีน, คาร์บ, ไขมัน, ไฟเบอร์, น้ำตาล, โซเดียม
...
กรุณาตอบในรูปแบบ JSON ที่มีโครงสร้างดังนี้:
{
  ...
  "nutrition": {
    ...
    "protein": ตัวเลขโปรตีน,
    "carbs": ตัวเลขคาร์โบไฮเดรต,
    "fat": ตัวเลขไขมัน,
    "fiber": ตัวเลขไฟเบอร์,
    "sugar": ตัวเลขน้ำตาล,
    "sodium": ตัวเลขโซเดียม
  },
    ...
    try {
      ...
      return {
        ...
        nutrition: {
          ...
          fiber: parsedResponse.nutrition?.fiber || 0,
          sugar: parsedResponse.nutrition?.sugar || 0,
          sodium: parsedResponse.nutrition?.sodium || 0
        },
