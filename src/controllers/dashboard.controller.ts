...
export class DashboardController {
  ...
  async getFoodLogs(@Request() req, @Query('date') date?: string) {
    ...
    try {
      ...
      return ResponseDto.success([], 'Failed to retrieve food logs');
    }
  }
  ...
  async createFoodLog(@Request() req, @Body() foodData: any) {
    ...
    try {
      ...
      return ResponseDto.success({}, 'Failed to create food log');
    }
  }
  ...
  async createExerciseLog(@Request() req, @Body() exerciseData: any) {
    ...
    try {
      ...
      return ResponseDto.success({}, 'Failed to create exercise log');
    }
  }
