...
export class HealthMetricController {
  ...
  async getHealthMetrics(
    ...
    try {
      const healthMetrics = await this.supabaseService.getHealthMetrics({
        ...query,
        user_id: userId,
      });
  ...
  async getHealthMetric(
    ...
    try {
      const healthMetric = await this.supabaseService.getHealthMetricById(
        id,
        userId,
      );
  ...
  async deleteHealthMetric(
    ...
    try {
      const deleted = await this.supabaseService.deleteHealthMetric(id, userId);
